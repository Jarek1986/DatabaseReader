...
public class FXMLController implements Initializable {
    ...
    public void TableColumnFilling() {
        ...
        ObservableList<String> columnValuesAll = FXCollections.observableArrayList();;
        ObservableList dataToTableList = FXCollections.observableArrayList();
        ObservableList dataToTableListTrue = FXCollections.observableArrayList();  // Obesrvable list with chosen values from each column
        SQLCon myCon8 = new SQLCon();
        int k = 0;

        for (int i = 0; i < items2.size(); i += 2) {
            name = new TableColumn(items2.get(i)); // Gets the name of column from database and set this name to column name in fxml
            name.setCellValueFactory(new PropertyValueFactory<TableFillerOne, String>("a" + k)); // Sets the propery of every column
            tableViewOne.getColumns().add(name);
            columnValues = myCon8.conection8(selectedItem, items2.get(i)); // Gets column values
            columnValuesAll.addAll(columnValues);
            k++;
        }

        //for (int i = 0; i < items2.size(); i += 2) {
        //-------------- Gets value in columns --------------
        System.out.println("Number of columns + type: " + items2.size());
        System.out.println("columnValuesAll.addAll size: " + columnValuesAll.size());

        int columnRange = columnValuesAll.size() / (items2.size() / 2);
        System.out.println("Column range: " + columnRange);
        for (int j = 0; j < columnRange; j++) {

            switch (items2.size() / 2) {
                case 1:
                    dataToTableList.add(new TableFillerOne(columnValuesAll.get(j)));
                    break;
                case 2:
                    dataToTableList.add(new TableFillerOne(columnValuesAll.get(j), 
                            columnValuesAll.get(j + columnRange)));
                    break;
                case 3:
                    dataToTableList.add(new TableFillerOne(columnValuesAll.get(j), 
                            columnValuesAll.get(j + columnRange), 
                            columnValuesAll.get(j + 2 * columnRange)));
                    break;
                case 4:
                    dataToTableList.add(new TableFillerOne(columnValuesAll.get(j), 
                            columnValuesAll.get(j + columnRange), 
                            columnValuesAll.get(j + 2 * columnRange), 
                            columnValuesAll.get(j + 3 * columnRange)));
                    break;
                    case 5:
                    dataToTableList.add(new TableFillerOne(columnValuesAll.get(j), 
                            columnValuesAll.get(j + columnRange), 
                            columnValuesAll.get(j + 2 * columnRange),
                            columnValuesAll.get(j + 3 * columnRange),
                            columnValuesAll.get(j + 4 * columnRange)));
                    break;
                    case 6:
                    dataToTableList.add(new TableFillerOne(columnValuesAll.get(j), 
                            columnValuesAll.get(j + columnRange), 
                            ...
                            columnValuesAll.get(j + 3 * columnRange),
                            columnValuesAll.get(j + 4 * columnRange),
                            columnValuesAll.get(j + 5 * columnRange)));
                    break;
                    case 7:
                    dataToTableList.add(new TableFillerOne(columnValuesAll.get(j), 
                            columnValuesAll.get(j + columnRange), 
                            ...
                            columnValuesAll.get(j + 4 * columnRange),
                            columnValuesAll.get(j + 5 * columnRange),
                            columnValuesAll.get(j + 6 * columnRange)));
                    break;
                    case 8:
                    dataToTableList.add(new TableFillerOne(columnValuesAll.get(j), 
                            columnValuesAll.get(j + columnRange), 
                            ...
                            columnValuesAll.get(j + 5 * columnRange),
                            columnValuesAll.get(j + 6 * columnRange),
                            columnValuesAll.get(j + 7 * columnRange)));
                    break;
                    case 9:
                    dataToTableList.add(new TableFillerOne(columnValuesAll.get(j), 
                            columnValuesAll.get(j + columnRange), 
                            ...
                            columnValuesAll.get(j + 6 * columnRange),
                            columnValuesAll.get(j + 7 * columnRange),
                            columnValuesAll.get(j + 8 * columnRange)));
                    break;
                    case 10:
                    dataToTableList.add(new TableFillerOne(columnValuesAll.get(j), 
                            columnValuesAll.get(j + columnRange), 
                            ...
                            columnValuesAll.get(j + 7 * columnRange),
                            columnValuesAll.get(j + 8 * columnRange),
                            columnValuesAll.get(j + 9 * columnRange)));
                    break;
            }
        ...
        //--------------------------------
        System.out.println("dataToTableList size: " + dataToTableList.size());

        dataToTableListTrue.addAll(dataToTableList); //.subList(range, range1));

        //---------------------------------         
        tableViewOne.setItems(dataToTableListTrue);
